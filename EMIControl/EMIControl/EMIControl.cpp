...
// EMIControl.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CEMIControlApp, CWinApp)
...
// 유일한 CEMIControlApp 개체입니다.

CEMIControlApp theApp;


// CEMIControlApp 초기화

BOOL CEMIControlApp::InitInstance()
{
