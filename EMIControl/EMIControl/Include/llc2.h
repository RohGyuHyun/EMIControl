 ...
 *	SUBPROJECT:	.
 *
 *	Description: Implementation of the llc UI
 *	
 ******************************************************************************
 *	
 *	Change Activity
...
//
const int* GetLLCSlots();
void OnExitLLC();
void ReinitAllLlcStatics();
...
#define  MB                               1
#define  MB_MB_MOVE_GRAPH                 2       /* callback function: OpenMoveGraph */
#define  MB_MB_SCANLINE                   3       /* callback function: OpenScanline */
#define  MB_CFG                           4
#define  MB_CFG_MB_PARAMETER              5       /* callback function: OpenParameter */
#define  MB_CFG_MB_CAPTURE                6       /* callback function: OpenCapture */
#define  MB_CFG_MB_CM                     7       /* callback function: CmOpen */
#define  MB_CFG_MB_ABC                    8       /* callback function: OpenABC */
#define  MB_CFG_MB_T                      9       /* callback function: OpenTiny */
#define  MB_CFG_MB_HOME                   10      /* callback function: OpenHome */
#define  MB_CFG_MB_VIDEO                  11      /* callback function: OpenVideo */
#define  MB_CFG_MB_EA                     12      /* callback function: EaOpen */
#define  MB_CFG_MB_SUPPORT                13      /* callback function: WsupportOpen */
#define  MB_MB_LED                        14      /* callback function: OpenLed */
#define  MB_MB_LLC                        15      /* callback function: OpenLlc */
#define  MB_MB_DIAG                       16
#define  MB_MB_DIAG_MB_ATFDIAG            17      /* callback function: OpenAtfDiagnostic */
#define  MB_MB_DIAG_MB_SERCOMDIAG         18      /* callback function: OpenSerialComDiagnostic */
#define  MB_MB_DIAG_MB_ATF_CAPTURE        19      /* callback function: OpenDataCaptureCb */
